...
router.setState = function (page) {
  ...
  } else if (page === "single entry") {
    document.querySelector("body").className = "single-entry";
    document.querySelector("title").innerText = "Individual Entry";
  } else if (page === "journal entries") {
    document.querySelector("body").classList.remove("settings", "single-entry");
    document.querySelector("title").innerText = "Journal Entries";
  }
  /**
